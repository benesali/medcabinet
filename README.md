...
- Bronze ingestors done — SÚKL (DLP, history, SPC, PIL) and DDInter; shared base (stream download, ZIP extraction, SourceName enum); date-stamped snapshots with SHA-256 manifests
