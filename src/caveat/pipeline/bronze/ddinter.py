...
def download(
    ...
    """Download DDInter interaction data to the bronze layer.
...
def main() -> None:
    """CLI entrypoint: download DDInter interaction data to the bronze layer."""
    logging.basicConfig(level=logging.INFO, format="%(levelname)s  %(message)s")

    parser = argparse.ArgumentParser(description="Download DDInter drug-drug interaction CSV to the bronze layer.")
    parser.add_argument(
        "--url",
        required=True,
